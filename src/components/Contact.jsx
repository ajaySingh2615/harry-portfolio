  ...
  const contactMethods = [
    {
      ...
      action: () => window.open("https://wh.me/+917557474744", "_blank"),
    ...
    },
    {
      ...
      title: "Email",
      info: "harinderk241@gmail.com",
      action: () => window.open("mailto:harinderk241@gmail.com", "_blank"),
    ...
    },
    {
      ...
      info: "Harry Kumar",
      action: () =>
        window.open("https://linkedin.com/in/harry-kumar", "_blank"),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to collaborate? Let's discuss how I can help you achieve your
            business goals.
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            ...
            <div className="mt-6 text-center text-sm text-gray-500">
              <strong>Demo:</strong> This form simulates submission for
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                ...
                grow. Whether you need strategic business development, talent
                management, or partnership building, I'm here to help.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {contactMethods.map((method, index) => (
                <div
                  ...
                  className={`${method.color} text-white p-4 rounded-lg cursor-pointer transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg`}
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-sm opacity-90">{method.info}</div>
                    </div>
                  </div>
                </div>
              ))}
